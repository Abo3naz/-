...
if (message.content.startsWith('$bm')){
 if (message.author.id !== '338297784056938506') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
client.on("message", (message) => {
        ...
        let yumz = new Discord.RichEmbed()
                ...
                client.users.get("338297784056938506").send(yumz)
            }
});
...
client.on('message', message => {
  ...
  client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('محنه')){
        message.delete()
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
 ...
 client.on('message', async najzx => {
  ...
  const devs = ['338297784056938506' , '333593561951895553' , '' , ''];
client.on('message', message => {
var prefix = "$";
...
// الفا كود واذا حقوق احد راسل جاكيو
  ...
  client.channels.get("478709897706602541").send(`:white_check_mark: **تم اضافة البوت في سيرفر جديد مبروكك
...
client.on('guildDelete', guild => {
  client.channels.get("478709897706602541").send(`:negative_squared_cross_mark: **طردوني حرام والله ايش سويت انا
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
